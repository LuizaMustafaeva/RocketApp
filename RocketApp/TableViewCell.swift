...
class TableViewCell: UITableViewCell {
    ...
    func setupView() {
        ...
        mainView.frame = CGRect(x: 20, y: 10, width: 330, height: 250)
        ...
        firstLabel.frame = CGRect(x: 40, y: 60, width: 330, height: 50)
        firstLabel.font = UIFont.systemFont(ofSize: 16.0)
        
        secondLabel.frame = CGRect(x: 40, y: 90, width: 330, height: 50)
        secondLabel.font = UIFont.systemFont(ofSize: 16.0)
        
        thirdLabel.frame = CGRect(x: 40, y: 120, width: 330, height: 50)
